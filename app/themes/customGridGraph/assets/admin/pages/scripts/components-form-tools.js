var ComponentsFormTools = function () {
    ...
    var handleTwitterTypeahead = function() {
        ...
        var numbers = new Bloodhound({
          ...
          local: [
            { num: 'customGridGraph' },
            { num: 'keenthemes' },
            { num: 'customGridGraph theme' },
            { num: 'customGridGraph template' },
            { num: 'keenthemes team' }
          ]
        });
        ...
        $('#typeahead_example_1').typeahead(null, {
          displayKey: 'num',
          hint: (customGridGraph.isRTL() ? false : true),
    ...
    var handleBootstrapMaxlength = function() {
        ...
        $('#maxlength_placement').maxlength({
            limitReachedClass: "label label-danger",
            alwaysShow: true,
            placement: customGridGraph.isRTL() ? 'top-right' : 'top-left'
        });
    }
    ...
    var handleUsernameAvailabilityChecker1 = function () {
        ...
        $("#username1_checker").click(function (e) {
            ...
            if (input.val() === "") {
                ...
                pop.popover('destroy');
                pop.popover({
                    'placement': (customGridGraph.isRTL() ? 'left' : 'right'),
                    'html': true,
                    'container': 'body',
                ...
                // set last poped popover to be closed on click(see customGridGraph.js => handlePopovers function)
                customGridGraph.setLastPopedPopover(pop);
                pop.popover('show');
        ...
        $("#username2_input").change(function () {
            ...
            $.post('demo/username_checker.php', {
                ...
                if (res.status == 'OK') {
                    ...
                    customGridGraph.setLastPopedPopover(input);
                }
