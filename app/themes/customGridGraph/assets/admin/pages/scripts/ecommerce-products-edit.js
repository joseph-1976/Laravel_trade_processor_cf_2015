var EcommerceProductsEdit = function () {
            ...
            init: {
                ...
                FileUploaded: function(up, file, response) {
                    ...
                    if (response.result && response.result == 'OK') {
                        ...
                        customGridGraph.alert({type: 'danger', message: 'One of uploads failed. Please retry.', closeInSeconds: 10, icon: 'warning'});
                    }
                },
         
                Error: function(up, err) {
                    customGridGraph.alert({type: 'danger', message: err.message, closeInSeconds: 10, icon: 'warning'});
                }
            }
        });
    ...
    var initComponents = function () {
        ...
        $(".datetime-picker").datetimepicker({
            isRTL: customGridGraph.isRTL(),
            autoclose: true,
            todayBtn: true,
            pickerPosition: (customGridGraph.isRTL() ? "bottom-right" : "bottom-left"),
            minuteStep: 10
        });
