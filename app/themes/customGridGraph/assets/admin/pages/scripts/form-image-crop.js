var FormImageCrop = function () {
    ...
    var demo4 = function() {
        ...
        customGridGraph.updateUniform('#fadetog');
    ...
    var demo5 = function() {
        ...
        function initJcrop()//{{{
        {
          ...
          $('#demo5').Jcrop({
            ...
            customGridGraph.updateUniform('#can_click,#can_move,#can_size');

            $('#ar_lock,#size_lock,#bg_swap').attr('checked',false);
            customGridGraph.updateUniform('#ar_lock,#size_lock,#bg_swap');
        ...
        function releaseCheck()
        {
          ...
          customGridGraph.updateUniform('#can_click');
        };
    ...
    return {
        ...
        init: function () {
            ...
            customGridGraph.addResizeHandler(handleResponsive);
            handleResponsive();
